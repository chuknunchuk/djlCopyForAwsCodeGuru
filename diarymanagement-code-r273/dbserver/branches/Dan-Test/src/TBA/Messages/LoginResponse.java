...
public class LoginResponse extends ResponseMessage
{
   ...
   /**
    * The GetResponse() Method gets the LoginResponse message including the
   ...
   public String GetResponse() throws MessagesException
   {
      ...
      message = String.format("%0" + Integer.toString(displayNameLen) + "s", displayName);
   ...
   public void SetResponse(String message) throws MessagesException
   {
      ...
      displayName = message.substring(0, displayNameLen - 1);
      message = message.substring(displayNameLen, message.length());

      try
      {
         diaryCountStr = message.substring(0,diaryCountLen - 1);
      ...
      try
      {
         defaultDiaryStr = message.substring(0, defaultDiaryLen - 1);
