...
/**
 * This abstract class is the root of all messages between the client and
...
public class Messages
{
   ...
   private final int sessionIDLen = 40;
   public static final int messageHeaderLen =  47;//messageLenSize+sessionIDLen+1
   ...
   protected String Get(String childMessage) throws MessagesException
   {
      ...
      if(sessionID == null)
      {
         sessionID = String.format("%0"+Integer.toString(sessionIDLen)+"s","");
    ...
    */
   public String SetHeader(String message) throws MessagesException
   {
      int messageLenPos = sessionIDLen + messageLenSize;
      ...
      messageLenString = message.substring(sessionIDLen + 1, messageLenPos);
      messageLen = Integer.parseInt(messageLenString, 16);
      if(message.length() != messageLen)
      {
         throw new MessagesException("The Message length is incorrect");
      }
      ...
      sessionID = message.substring(1, sessionIDLen);

      return message.substring(messageLenPos+1, message.length());
   }
    ...
    *<p> 
    * @param ID The Session ID to set. Must be a 40-digit Hex number, as a string.
    *<p>
    * @throws MessagesException
    *<p>
    * @see #GetSessionID() 
