...
public class ResponseMessage extends Messages
{
    ...
    */
   protected String Set(String message) throws MessagesException
   {
      ...
      try
      {
         errorCode = Integer.parseInt(message.substring(0,errorCodeLen - 1), 16);
      ...
      if(errorCode > 0)
      {
         int delimPos = message.indexOf(Character.getNumericValue('|'));
         errorMessage = message.substring(0,delimPos - 1);
