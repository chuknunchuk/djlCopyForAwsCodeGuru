 ...
 * @author Dan McGrath
 *
 * @version $Rev:: 249           $ $Date:: 2009-10-23 #$
 */
...
\    */
    ...
    */
    ...
    private void SettingsMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SettingsMenuItemActionPerformed
        ...
        //SettingsDialog settingsDialog = new SettingsDialog(this, true,soundResources);
        ...
        soundResources.setSoonLocation(settingsDialog.getSoonLocation());*/
        openSettings();
   ...
   */
   ...
   private void mouseGestureEngine()
   {
      ...
      for(Gesture nextGesture : gesturesResource.getGestures())
      {
         ...
         System.out.println(nextGesture.getGestureName());
         
         //if(nextGesture.getGestureName().equalsIgnoreCase("Shake Sideways"))
         ...
         //else if (nextGesture.getGestureName().equalsIgnoreCase("Clockwise"))
         ...
         //else if (nextGesture.getGestureName().equalsIgnoreCase("Anti-Clockwise"))
...
//         settingsDialog.setMouseResources(gesturesResource);
      }
