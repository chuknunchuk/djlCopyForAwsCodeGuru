...
public class ServerCom
{
   ...
   public ServerCom(String machineName, int portNumber) throws ServerComException
   {
      try
      {
          InetAddress ina = InetAddress.getByName(machineName);
          
           if(NetwConfig.isProxyOn() == true)
           {
               MyConx = NetwConfig.getProxySocket();
               
               SocketAddress connectTo = new InetSocketAddress(ina,portNumber);
				
               MyConx.connect(connectTo,30);
