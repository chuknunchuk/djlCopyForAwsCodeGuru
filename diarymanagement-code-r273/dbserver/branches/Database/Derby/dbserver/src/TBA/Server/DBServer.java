...
executeUpdate("insert INTO diaries(ID, USER, DIARYID, PERMISSIONS) values(0, 'dmcgra',0, 777)");
executeUpdate("insert INTO diaries(ID, USER, DIARYID, PERMISSIONS) values(1, 'dmcgra',1, 777)");
         //*/
