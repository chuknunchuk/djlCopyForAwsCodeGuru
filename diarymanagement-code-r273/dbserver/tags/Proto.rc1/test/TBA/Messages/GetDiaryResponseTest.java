...
/*   public void testGetDiaryResponseLen()
   ...
   public void testGet() throws Exception
   {
      ...
      String expStartDateRec = "20091014";
      String resStartDateRec;

      String expEndDateRec = "20091014";
      String resEndDateRec;
      ...
      setDiaryEntry.setStartDate(expStartDateRec);
      setDiaryEntry.setEndDate(expEndDateRec);
      setDiaryEntry.setStartTime(expStartTimeRec);
      setDiaryEntry.setEndTime(expEndTimeRec);
      ...
      try
      {
         ...
         //System.out.println(setInstance.Get(""));
         ...
         //assertEquals(entryRecords,resEntryRecords);*/
