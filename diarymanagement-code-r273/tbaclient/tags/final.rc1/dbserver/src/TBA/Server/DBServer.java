 ...
 * @author Dan McGrath
 *
 * @version $Rev:: 234           $ $Date:: 2009-10-22 #$
 *
 * @see dbserver.SQLite
 */
class DBServer extends SQLite {
    ...
    private PreparedStatement rmvPremissions;
    ...
    public void setup() throws DBServerException {
        ...
        try {
            ...
            commandline = stdin.readLine().charAt(1);
            commandline = Character.toUpperCase(commandline);
            if (commandline == 'Y') {
            RealDatabase();
            }
            //
            ...
            LOGIT.finest("Setup removing all diary premissions for a user.");
            ...
            rmvPremissions = connex.prepareStatement(sql);
            ...
            LOGIT.finest("Setup removes Diaries Premissions");
    ...
    public void RealDatabase() {
        // Drop Table from another


        DropTables();
        // Drop Triggers of the old System
        DropTriggers();
    ...
    public int SmartList(String usr, int type) {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                System.out.println("[" + i + "] : " + rset.getString(0));
                System.out.println("inside");
            ...
            System.out.println("[-1] : None of the above (Cancle transation)");
            System.out.println("$");
            BufferedReader stdin = new BufferedReader(new InputStreamReader(System.in));
            int result;
            result = stdin.read();
    ...
    public String Addusr(String usr, String pws, String DisplayName, String DiaryName) throws DBServerException {
        ...
        try {
            ...
            //Add Premissions For The User To DIARIES
    ...
    private String addDiary(Integer DiaryId, String Diaryname, String owner, String time) throws DBServerException {
        try {
            ...
            return "Succefully added Diary" + DiaryId;
        } catch (SQLException ex) {
            LOGIT.severe("Unable to set values in an SQL prepared statement");
            LOGIT.info(ex.getLocalizedMessage());
            throw new DBServerException(ex.getLocalizedMessage());
    ...
    /**
     * This Is Used To Add Premissions In The Server Command Line
     */
    private String addDiaries(String usr, Integer diaryid, String premissions) throws DBServerException {

        try {
            //Adds Premissions To A User On A Diary
    ...
    /**
     * This Is Used To Check DairyID BeforeAdding Premissions In The Server Command Line
     */
    public String addPremission(String usr, Integer diaryid, String premissions) throws DBServerException {
        String outcome = "";
        /////////////////////// Check format of the premissions string could be number of letter
        outcome = addDiaries(usr, diaryid, premissions);
        return outcome;
    }
    ...
    public String Adddry(String usr, String DiaryName) throws DBServerException {
        ...
        //Adds The Premissions To The DIARIES Tabel
    ...
    private String dumRmUsr(String usr) {
        try {
            ...
            //Removes All Premissions That The User Has
    ...
    /**
     * This Is Used To Remove A Users Premissions From The Diary
     */
    public String rmPer(String usr, String diaryid) {
        ...
        try {
            ...
            if (temp > 0) {
                chkPremissions.setString(1, usr);
                chkPremissions.setString(2, diaryid);
                ResultSet rset = chkPremissions.executeQuery();
                if (rset.next()) {
                    diaryid = String.valueOf(rset.getInt(1));
                }
            }
            //Removes The Premissions From DIARIES
            rmvPremissions.setString(1, usr);
            rmvPremissions.setString(2, diaryid);
            rmvPremissions.executeUpdate();
        } catch (SQLException ex) {
            Logger.getLogger(DBServer.class.getName()).log(Level.SEVERE, null, ex);
        }
        return usr + " premissions have been revoked from diary " + diaryid + ".";
    }
