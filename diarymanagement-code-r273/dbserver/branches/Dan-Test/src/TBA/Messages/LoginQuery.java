...
public class LoginQuery extends QueryMessage
{
    ...
    */
   public String GetQuery() throws MessagesException
   {
      String message = null;
    ...
    */
   public void SetQuery(String message) throws MessagesException
   {
      ...
      userName = message.substring(0, userNameLen-1).trim();
