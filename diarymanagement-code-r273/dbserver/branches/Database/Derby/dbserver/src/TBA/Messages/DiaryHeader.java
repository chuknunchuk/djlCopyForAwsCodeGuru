...
public class DiaryHeader
{
   ...
   public String Get() throws MessagesException
   {
      ...
      record += String.format("%0" + Integer.toString(diaryNameLen) + "s", diaryName);
      record += ownerFlag;
   ...
   public String Set(String record) throws MessagesException
   {
      ...
      try
      {
         diaryID = Integer.parseInt(record.substring(0,diaryIDLen - 1), 16);
      ...
      diaryName = record.substring(0, diaryNameLen - 1);
      ...
      try
      {
         permissions = Integer.parseInt(record.substring(1, permissionsLen), 8);
